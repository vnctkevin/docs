...
# Services Dashboards[#](#services-dashboards "Permanent link")
...
## Step 1: Access Grafana[#](#step-1-access-grafana "Permanent link")
...
![monitoring tab](../../../assets/images/admin/monitoring/monitoring_tab.png)

Monitoring tab

Click on the _Grafana_ link to open the Grafana web application and navigate through the dashboards.

## Step 2: Navigate through the dashboards[#](#step-2-navigate-through-the-dashboards "Permanent link")
...
![Grafana view](../../../assets/images/admin/monitoring/grafana.png)
