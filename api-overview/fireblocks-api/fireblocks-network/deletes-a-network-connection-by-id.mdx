---
title: "Deletes A Network Connection By Id"
---
  
  # Deletes a network connection by ID

delete https://api.fireblocks.io/v1/network\_connections/{connectionId}
...
https://api.fireblocks.io/v1/network\_connections/{connectionId}