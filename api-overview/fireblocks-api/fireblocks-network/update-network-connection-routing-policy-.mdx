---
title: "Update Network Connection Routing Policy "
---
  
  # Update network connection routing policy.

patch https://api.fireblocks.io/v1/network\_connections/{connectionId}/set\_routing\_policy
...
Supported asset groups for routing police can be found at <button aria-label="Copy Code" class="rdmd-code-copy fa"></button><code class="rdmd-code lang- theme-light" data-lang="" name="" tabindex="0">/network_ids/routing_policy_asset_groups</code>
...
https://api.fireblocks.io/v1/network\_connections/{connectionId}/set\_routing\_policy