---
title: "Update Network Id Routing Policy "
---
  
  # Update network id routing policy.

patch https://api.fireblocks.io/v1/network\_ids/{networkId}/set\_routing\_policy
...
https://api.fireblocks.io/v1/network\_ids/{networkId}/set\_routing\_policy