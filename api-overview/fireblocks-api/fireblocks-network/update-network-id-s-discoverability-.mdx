---
title: "Update Network Id S Discoverability "
---
  
  # Update network ID's discoverability.

patch https://api.fireblocks.io/v1/network\_ids/{networkId}/set\_discoverability
...
https://api.fireblocks.io/v1/network\_ids/{networkId}/set\_discoverability