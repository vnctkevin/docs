---
title: "Update Network Id S Name "
---
  
  # Update network ID's name.

patch https://api.fireblocks.io/v1/network\_ids/{networkId}/set\_name
...
https://api.fireblocks.io/v1/network\_ids/{networkId}/set\_name