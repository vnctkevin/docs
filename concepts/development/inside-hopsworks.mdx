...
![](../../../assets/images/concepts/dev/dev-inside.svg)

### Jupyter Notebooks[#](#jupyter-notebooks "Permanent link")
...
### Source Code Control[#](#source-code-control "Permanent link")
...
### Conda Environment per Project[#](#conda-environment-per-project "Permanent link")
...
### Orchestration[#](#orchestration "Permanent link")
