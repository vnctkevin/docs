...
### Training Pipelines on Hopsworks[#](#training-pipelines-on-hopsworks "Permanent link")
...
![](../../../assets/images/concepts/mlops/training-pipeline.svg)

Hopsworks [Model Registry](../registry/) and [Model Serving](../kserve/) capabilities can then be used to build a batch or online prediction service using the model.