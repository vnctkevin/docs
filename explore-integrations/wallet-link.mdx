...
```
</CodeGroup># [Approving a Web3 connection request](#approving-a-web3-connection-request)
...
```
</CodeGroup># [Removing a connection](#removing-a-connection)
...
```
</CodeGroup># [Signing a dApp-originated transaction](#signing-a-dapp-originated-transaction)
