...
Use the <button aria-label="Copy Code" class="rdmd-code-copy fa"></button><code class="rdmd-code lang- theme-light" data-lang="" name="" tabindex="0">Create a new transaction</code> endpoint call to <a target="_self" href="/docs/exchange-transfers">manage external transfers to and from your linked exchange accounts</a>.
