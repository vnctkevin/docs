...
### [Reduce the Number of Confirmations When:](#reduce-the-number-of-confirmations-when)
...
### [Increase the Number of Confirmations When:](#increase-the-number-of-confirmations-when)
