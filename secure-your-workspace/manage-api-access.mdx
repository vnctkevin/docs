...
Each API user requires a corresponding public/private key pair used to sign requests. It is <em>imperative</em> that you keep your <span class="GlossaryItem-trigger">Fireblocks Secret Key</span> (<button aria-label="Copy Code" class="rdmd-code-copy fa"></button><code class="rdmd-code lang- theme-light" data-lang="" name="" tabindex="0">fireblocks_secret.key</code>) safe and secure.
