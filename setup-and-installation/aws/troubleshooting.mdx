...
## Unauthorized error during cluster creation[#](#unauthorized-error-during-cluster-creation "Permanent link")
...
![Unauthorized error during cluster creation](../../../assets/images/setup_installation/managed/aws/troubleshooting-unauthorized-error.png)
...
## Missing permissions error during cluster creation[#](#missing-permissions-error-during-cluster-creation "Permanent link")
