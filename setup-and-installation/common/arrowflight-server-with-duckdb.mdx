---
title: "ArrowFlight Server With DuckDB"
---

# ArrowFlight Server with DuckDB[#](#arrowflight-server-with-duckdb "Permanent link")
...
*   [reading Feature Groups](https://docs.hopsworks.ai/feature-store-api/3.7/generated/api/feature_group_api/#read)
*   [reading Queries](https://docs.hopsworks.ai/feature-store-api/3.7/generated/api/query_api/#read)
*   [reading Training Datasets](https://docs.hopsworks.ai/feature-store-api/3.7/generated/api/feature_view_api/#get_training_data)
*   [creating In-Memory Training Datasets](https://docs.hopsworks.ai/feature-store-api/3.7/generated/api/feature_view_api/#training_data)
*   [reading Batch Inference Data](https://docs.hopsworks.ai/feature-store-api/3.7/generated/api/feature_view_api/#get_batch_data)
...
## Service configuration[#](#service-configuration "Permanent link")
...
![Configure RonDB](../../../assets/images/setup_installation/managed/common/arrowflight_rondb.png)
